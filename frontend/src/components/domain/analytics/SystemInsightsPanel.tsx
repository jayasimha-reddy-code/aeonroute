...
export function SystemInsightsPanel({ insights = DEFAULT_INSIGHTS }: SystemInsightsPanelProps) {
  return (
    <Card className="group relative overflow-hidden">
      ...
      <div className="flex items-center gap-2.5 mb-5 relative">
        ...
        <h3 className="text-sm font-semibold text-white uppercase tracking-wider">System Insights</h3>
      </div>
