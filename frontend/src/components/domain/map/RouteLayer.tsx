...
export const RouteLayer = memo(function RouteLayer({
  ...
  const highlightColor = 
    routeMode === 'eco' ? '#10b981' : 
    routeMode === 'scenic' ? '#a855f7' : 
    routeMode === 'gnn' ? '#ec4899' :
    routeMode === 'hybrid' ? '#14b8a6' :
    routeMode === 'dqn' ? '#ef4444' :
    routeMode === 'astar' ? '#8b5cf6' :
    routeMode === 'dijkstra' ? '#6366f1' :
    '#3b82f6';
