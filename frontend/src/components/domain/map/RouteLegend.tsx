...
export const RouteLegend = memo(function RouteLegend({
  ...
  return (
    <div
      className="absolute bottom-3 left-3 z-10 rounded-2xl bg-white/[0.04] backdrop-blur-[40px] border border-white/10 border-t-white/20 shadow-[0_8px_32px_rgba(0,0,0,0.4)] p-2.5 space-y-1"
      style={{ minWidth: 160 }}
    >
