...
const variants = {
  primary: 'bg-emerald-500 text-slate-950 font-semibold hover:bg-emerald-400 hover:shadow-glow-emerald-lg active:scale-[0.97] shadow-[0_0_20px_rgba(16,185,129,0.25)]',
  ...
  outline: 'border border-white/[0.10] text-slate-400 hover:text-white hover:border-white/[0.18] hover:bg-white/[0.05] hover:shadow-card',
};
