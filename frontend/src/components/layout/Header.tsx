...
export default function Header() {
  ...
  return (
    <header className="h-16 flex items-center justify-between px-6 lg:px-8 bg-[#0a0f16]/40 backdrop-blur-xl border-b border-white/[0.04] sticky top-0 z-40 transition-all duration-300 shadow-sm">
      {/* Page title */}
      <h1 className="text-[1.1rem] font-bold text-white tracking-tight">{title}</h1>
